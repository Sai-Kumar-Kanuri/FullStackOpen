...
const App = () => {
  ...
  return (
    <div>
      ...
      <Display anecdotes={anecdotes[selected]} votesCount={allVotes[selected]}></Display>
      <Button onClick={handleVotes} name='vote' />
      <Button onClick={handleSelect} name='next anecdote' />
      <Heading tag='Anecdote with most votes' />
